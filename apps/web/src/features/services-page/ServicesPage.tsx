  ...
  return (
    ...
    >
      <Link
        ...
        to={`/services/${slug}`}
      >
        <ImageFrame alt={service.imageAlt || service.name} className="h-[190px] w-full shrink-0 rounded-none border-0 bg-[#eaf2f6] shadow-none" presentation={service.imagePresentation} src={service.imageUrl} />
