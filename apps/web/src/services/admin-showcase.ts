...
const adminShowcaseContent: AdminShowcaseContent = {
  articles: [
    ...
    },
    {
      ...
      homepageVisibility: true,
      id: 'what-to-expect-during-your-first-visit-psa-chas',
      imageAlt: 'Arunreah Dental Clinic Psa Chas Branch exterior building',
      imageUrl: '/assets/landing/psa-chas-exterior.jpg',
      lastUpdatedAuthor: 'Admin',
      lastUpdatedDate: 'Sep 23, 2026',
      order: 2,
      status: 'published',
      structure: {
        bodyContent:
          'Welcome to Arunreah Dental Clinic Psa Chas branch. Our clinic is designed for comfort, equipped with modern dental technology, and staffed by a dedicated, caring dental team.',
        coverImage: '/assets/landing/psa-chas-exterior.jpg',
        ctaButtonCount: 1,
        headline: 'What To Expect During Your First Visit - Psa Chas Branch',
        relatedCardsCount: 2,
        sectionBlocksCount: 3,
        shortSummary: 'Experience modern, gentle dental care at our Psa Chas branch near Old Market in Phnom Penh.',
      },
      subtitle: 'Modern clinic near Old Market...',
      title: 'What To Expect During Your First Visit - Psa Chas Branch',
    },
    {
      category: 'Clinic Experience',
      homepageVisibility: true,
      id: 'what-to-expect-during-your-first-visit',
      imageAlt: 'Modern dental clinic treatment room in Toul Tompoung',
      ...
      structure: {
        ...
        ctaButtonCount: 1,
        headline: 'What To Expect During Your First Visit - Toul Tompoung Branch',
        relatedCardsCount: 2,
        sectionBlocksCount: 4,
        shortSummary: 'A friendly guide to walking into our Toul Tompoung clinic and experiencing personalized care.',
      },
      subtitle: 'A friendly guide to...',
      title: 'What To Expect During Your First Visit - Toul Tompoung Branch',
    },
    {
      category: 'Smile Care',
