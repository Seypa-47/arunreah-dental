import type { AdminBranchListQuery, AdminBranchRead, AdminDoctorListQuery, AdminShowcaseListQuery, ClinicSettingsAdminRead, ContactSettingsAdminRead, CreateAboutTimelineInput, CreateBranchInput, CreateDoctorInput, CreatePageMediaInput, CreateServiceInput, CreateShowcaseInput, ImagePresentation, PageMediaPlacement, ServiceListQuery, UpdateAboutTimelineInput, UpdateBranchInput, UpdateClinicSettingsInput, UpdateContactSettingsInput, UpdateDoctorInput, UpdatePageMediaInput, UpdateServiceInput, UpdateShowcaseInput } from '@arunreah/shared';
...
export type AdminShowcaseRecord = { id: string; slug: string; status: 'DRAFT' | 'PUBLISHED' | 'ARCHIVED'; showOnHomepage: boolean; displayOrder: number; titleEn: string; titleKm: string; categoryEn: string | null; categoryKm: string | null; summaryEn: string | null; summaryKm: string | null; bodyEn: string | null; bodyKm: string | null; coverImageKey: string | null; coverImagePresentation: ImagePresentation; metaTitleEn: string | null; metaTitleKm: string | null; metaDescriptionEn: string | null; metaDescriptionKm: string | null; createdAt: string; updatedAt: string };
export type AdminShowcaseDetail = AdminShowcaseRecord & { sections: { id?: string; sectionType: 'TEXT' | 'IMAGE' | 'QUOTE'; headingEn: string | null; headingKm: string | null; bodyEn: string | null; bodyKm: string | null; imageKey: string | null; imagePresentation?: ImagePresentation; displayOrder: number }[]; relatedShowcaseIds: string[] };
export type AdminPageMediaRecord = { id: string; placement: PageMediaPlacement; status: 'DRAFT' | 'PUBLISHED' | 'ARCHIVED'; titleEn: string | null; titleKm: string | null; bodyEn: string | null; bodyKm: string | null; badgeEn: string | null; badgeKm: string | null; discountEn: string | null; discountKm: string | null; benefitsEn: string | null; benefitsKm: string | null; validUntil: string | null; imageKey: string; imagePresentation: import('@arunreah/shared').ImagePresentation; displayOrder: number; createdAt: string; updatedAt: string };
