...
export async function fetchBookAppointmentPage(): Promise<BookAppointmentPageContent> {
  return {
    actions: landingPageContent.actions,
    branches: [
      {
        address: '123, Street 155, Sangkat Toul Tompoung I, Khan Chamkarmon, Phnom Penh, Cambodia',
        imageAlt: 'Arunreah Dental Clinic Toul Tompoung branch preview',
        imageUrl: '/assets/landing/figma-branches/image3_183_4173.jpg',
        mapLabel: 'View on Map',
        mapUrl: 'https://www.google.com/maps/search/?api=1&query=Arunreah%20Dental%20Clinic%20Toul%20Tompoung',
        name: 'Arunreah Dental Clinic - TTP',
      ...
      {
        address: '45, Street 13, Sangkat Wat Phnom, Khan Daun Penh, Phnom Penh, Cambodia',
        imageAlt: 'Arunreah Dental Clinic Psa Chas branch preview',
        imageUrl: '/assets/landing/figma-branches/image4_183_4173.jpg',
        mapLabel: 'View on Map',
        mapUrl: 'https://www.google.com/maps/search/?api=1&query=Arunreah%20Dental%20Clinic%20Psa%20Chas',
        name: 'Arunreah Dental Clinic - Psa Chas',
    ...
    calendar: {
      dates: [
        { day: 26, disabled: true, key: '2026-04-26', muted: true },
        { day: 27, disabled: true, key: '2026-04-27', muted: true },
        { day: 28, disabled: true, key: '2026-04-28', muted: true },
        { day: 29, disabled: true, key: '2026-04-29', muted: true },
        { day: 30, disabled: true, key: '2026-04-30', muted: true },
        { day: 1, key: '2026-05-01' },
        { day: 2, key: '2026-05-02' },
        { day: 3, key: '2026-05-03' },
        { day: 4, key: '2026-05-04' },
        { day: 5, key: '2026-05-05' },
        { day: 6, key: '2026-05-06' },
        { day: 7, key: '2026-05-07' },
        { day: 8, key: '2026-05-08' },
        { day: 9, key: '2026-05-09' },
        { day: 10, key: '2026-05-10' },
        { day: 11, key: '2026-05-11' },
        { day: 12, key: '2026-05-12' },
        { day: 13, key: '2026-05-13' },
        { day: 14, key: '2026-05-14' },
        { day: 15, key: '2026-05-15' },
        { day: 16, key: '2026-05-16' },
        { day: 17, key: '2026-05-17' },
        { day: 18, key: '2026-05-18' },
        { day: 19, key: '2026-05-19' },
        { day: 20, key: '2026-05-20' },
        { day: 21, key: '2026-05-21' },
        { day: 22, key: '2026-05-22' },
        { day: 23, key: '2026-05-23' },
        { day: 24, key: '2026-05-24' },
        { day: 25, key: '2026-05-25' },
        { day: 26, key: '2026-05-26' },
        { day: 27, key: '2026-05-27' },
        { day: 28, key: '2026-05-28' },
        { day: 29, key: '2026-05-29' },
        { day: 30, key: '2026-05-30' },
        { day: 31, key: '2026-05-31' },
        { day: 1, disabled: true, key: '2026-06-01', muted: true },
        { day: 2, disabled: true, key: '2026-06-02', muted: true },
        { day: 3, disabled: true, key: '2026-06-03', muted: true },
        { day: 4, disabled: true, key: '2026-06-04', muted: true },
        { day: 5, disabled: true, key: '2026-06-05', muted: true },
        { day: 6, disabled: true, key: '2026-06-06', muted: true },
      ],
      monthLabel: 'May 2026',
      selectedDateKey: '2026-05-16',
      selectedDateLabel: 'Saturday, 16 May 2026',
      weekdays: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
    },
    doctors: [
      { name: 'Any Available Doctor', value: 'any' },
      ...doctorProfiles.map((doctor) => ({
        name: doctor.name,
        value: doctor.detail.profileHref.split('/').at(-1) ?? doctor.name,
      })),
    ],
    footer: publicPageFooter(),
    form: {
      ...
      placeholders: {
        email: 'Enter your email address',
        fullName: 'Enter your full name',
        notes: 'Tell us more about your concern',
        phone: 'Enter your phone number',
      },
      submitLabel: 'Confirm Appointment',
    },
    help: {
      email: 'info@arunreahclinic.com',
      phone: '069 978 997 / 061 978 997',
      subtitle: 'Our team is ready to assist you.',
      title: 'Need Help?',
    },
    hero: {
      backgroundImageAlt: 'Arunreah Dental Clinic treatment room',
      backgroundImageUrl: '/assets/landing/figma-branches/image2_183_4173.png',
      subtitle: "We're here to make your dental care experience simple, comfortable, and personalized.",
    ...
    services: servicesPageServices,
    servicesList: [
      { name: 'General & Pediatric Dentistry', value: 'general-pediatric-dentistry' },
      ...servicesPageServices.map((service) => ({
        name: service.name,
        value: serviceSlug(service.name),
      })),
    ],
    summary: {
    ...
    times: ['08:00 AM', '09:00 AM', '10:00 AM', '11:00 AM', '02:00 PM', '03:00 PM', '04:00 PM'],
  };
}
