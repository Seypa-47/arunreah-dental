...
export type PublicPageMedia = { id: string; imageKey: string; title: string | null; body: string | null; badge: string | null; benefits: string | null; discount: string | null; validUntil: string | null; displayOrder: number };
