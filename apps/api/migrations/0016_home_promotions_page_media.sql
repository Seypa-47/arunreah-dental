...
CREATE TABLE `page_media_next` (
  ...
  CONSTRAINT `page_media_placement_check` CHECK(placement in ('HOME_PROMOTIONS', 'ABOUT_PROFESSIONAL_DEVELOPMENT', 'ABOUT_ADVANCED_FACILITIES', 'DOCTORS_HERO', 'DOCTORS_PATIENT_EDUCATION')),
